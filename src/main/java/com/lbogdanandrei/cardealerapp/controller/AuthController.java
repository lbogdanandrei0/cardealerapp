...
public class AuthController {
    ...
    @PostMapping("/signin")
    public AuthenticationResponse login(@Valid @RequestBody LoginRequestDTO requestBody){
    ...
    public AuthenticationResponse refreshToken(@Valid @RequestBody RefreshTokenRequestDTO request){
